...
@section('content')
    <div class="container p-3">
        ...
        @endif
            ...
            <form method="POST" action="{{route('myuser_store')}}" enctype="multipart/form-data" class="container foom">
            @csrf
                ...
                <div>
                 ...
                 <div method="POST" action="{{route('myuser_store')}}" enctype="multipart/form-data">
